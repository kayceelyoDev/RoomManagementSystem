        ...
        <form wire:submit.prevent="addroom" class="space-y-6">
                ...
                <div
                    ...
                    <label class="flex cursor-pointer flex-col items-center gap-2">
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG up to 10MB (Multiple files
                            allowed)</span>
                        <input type="file" class="hidden" multiple accept="image/*" wire:model="images" />
                    </label>
                </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="room-name" wire:model="roomName" placeholder="e.g., Deluxe Suite"
                ...
                <div>
                    ...
                    <input type="text" id="room-number" wire:model="roomNumber" placeholder="e.g., 101"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-400 dark:focus:ring-blue-400" />
                    @error('roomNumber')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="room-rate" wire:model="roomRate" placeholder="0.00" step="0.01"
                ...
                <div>
                    ...
                    <input type="number" id="room-capacity" wire:model="roomCapacity" placeholder="e.g., 2"
                        min="1"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-400 dark:focus:ring-blue-400" />
                    @error('roomCapacity')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            ...
            <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <flux:button type="submit" variant="primary" loading="addroom"
